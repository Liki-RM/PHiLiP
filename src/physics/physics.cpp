...
template class PhysicsBase < PHILIP_DIM, 9, double >;
template class PhysicsBase < PHILIP_DIM, 10, double >;
template class PhysicsBase < PHILIP_DIM, 11, double >;
template class PhysicsBase < PHILIP_DIM, 12, double >;
template class PhysicsBase < PHILIP_DIM, 13, double >;
template class PhysicsBase < PHILIP_DIM, 14, double >;
template class PhysicsBase < PHILIP_DIM, 15, double >;
...
template class PhysicsBase < PHILIP_DIM, 9, FadType >;
template class PhysicsBase < PHILIP_DIM, 10, FadType >;
template class PhysicsBase < PHILIP_DIM, 11, FadType >;
template class PhysicsBase < PHILIP_DIM, 12, FadType >;
template class PhysicsBase < PHILIP_DIM, 13, FadType >;
template class PhysicsBase < PHILIP_DIM, 14, FadType >;
template class PhysicsBase < PHILIP_DIM, 15, FadType >;
...
template class PhysicsBase < PHILIP_DIM, 9, RadType >;
template class PhysicsBase < PHILIP_DIM, 10, RadType >;
template class PhysicsBase < PHILIP_DIM, 11, RadType >;
template class PhysicsBase < PHILIP_DIM, 12, RadType >;
template class PhysicsBase < PHILIP_DIM, 13, RadType >;
template class PhysicsBase < PHILIP_DIM, 14, RadType >;
template class PhysicsBase < PHILIP_DIM, 15, RadType >;
...
template class PhysicsBase < PHILIP_DIM, 9, FadFadType >;
template class PhysicsBase < PHILIP_DIM, 10, FadFadType >;
template class PhysicsBase < PHILIP_DIM, 11, FadFadType >;
template class PhysicsBase < PHILIP_DIM, 12, FadFadType >;
template class PhysicsBase < PHILIP_DIM, 13, FadFadType >;
template class PhysicsBase < PHILIP_DIM, 14, FadFadType >;
template class PhysicsBase < PHILIP_DIM, 15, FadFadType >;
...
template class PhysicsBase < PHILIP_DIM, 9, RadFadType >;
template class PhysicsBase < PHILIP_DIM, 10, RadFadType >;
template class PhysicsBase < PHILIP_DIM, 11, RadFadType >;
template class PhysicsBase < PHILIP_DIM, 12, RadFadType >;
template class PhysicsBase < PHILIP_DIM, 13, RadFadType >;
template class PhysicsBase < PHILIP_DIM, 14, RadFadType >;
template class PhysicsBase < PHILIP_DIM, 15, RadFadType >;
